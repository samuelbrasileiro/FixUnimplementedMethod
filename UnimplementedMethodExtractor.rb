class UnimplementedMethodExtractor
	...
	def getInfoDefaultCase(buildLog)
		...
		categoryMissingSymbol = getTypeUnimplementedMethod(methodNames[0])
		filesInformation = []
		count = 0
	...
	def getInfoThirdCase(buildLog)
		...
		return "UnimplementedMethodFileSpecialCase", filesInformation, filesInformation.size
	end
...
#print UnimplementedMethodExtractor.extractionFilesInfo(log)
# Retorno: ["UnimplementedMethodVariable", [["GzipSource", "deadline", "GzipSource"]], 1]
